...
html_path = r"d:\Study\HTX\src\main\resources\static\admin.html"
with open(html_path, "r", encoding="utf-8") as f:
    content = f.read()

# Replace everything from <script src="...bootstrap..."></script> onwards
...
new_content = re.sub(r'<script src="https://cdn\.jsdelivr\.net/npm/bootstrap@5\.3\.0/dist/js/bootstrap\.bundle\.min\.js"></script>.*', new_script, content, flags=re.DOTALL)
